...
const servisPendaftaran = async (username, password, namaLengkap, namaIbuKandung) => {
  try {
    const data = {
      username,
      password,
    ...
    const result = await axios.post('http://localhost:5000/pengguna/daftar', data, {
      headers: {
...
export default servisPendaftaran;